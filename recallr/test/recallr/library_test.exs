defmodule Recallr.LibraryTest do
  use Recallr.DataCase
  ...
  describe "passages" do
    ...
    @valid_attrs %{name: "some name", rounds: 42, text: "some text"}
    @update_attrs %{name: "some updated name", rounds: 43, text: "some updated text"}
    @invalid_attrs %{name: nil, rounds: nil, text: nil}
